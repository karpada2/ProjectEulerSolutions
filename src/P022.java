...
public final class P022 implements Solution {
    ...
    public String run() {
        ...
        for (int i = 0; i < names.length; i++) {
            int temp = evaluateScore(names[i]) * (i+1);
            totalScore = totalScore.add(new BigInteger(Integer.toString(temp)));
        }

        return totalScore.toString();
    }

    public int evaluateScore(String name) {
        int sum = 0;
    ...
    private static String[] names = {  // 10 strings per line, except final line. Mutable array
